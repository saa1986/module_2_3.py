...
i = 0
while i < len(my_list):  # Нужно выписывать из этого списка только положительные числа до тех пор, пока не встретите отрицательное или не закончится список (выход за границу).
    if my_list[i]<0:
        i += 1
        continue
    elif my_list[i]==0: # 0 - не отрицательное и не положительное число.
        i +=1
